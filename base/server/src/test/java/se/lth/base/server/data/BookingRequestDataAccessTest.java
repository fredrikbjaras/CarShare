...
public class BookingRequestDataAccessTest {
	...
	Long bookingDepartureTime = Long.parseLong("1539613038607");
	Long bookingArrivalTime = Long.parseLong("1539628888607");
	Long bookingEndTimeMillis = Long.parseLong("1539620000007");
	...
	public void addBookingRequest() {
		...
		Route route = routeDao.addRoute(test1.getUserID(), 1000, "", "There", new Timestamp(bookingDepartureTime),new Timestamp(bookingArrivalTime), "", "Ride", new Timestamp(bookingEndTimeMillis), 0, false);
	...
	public void getAllBookingRequests() {
		...
		Route route1 = routeDao.addRoute(test1.getUserID(), 1000, "", "There", new Timestamp(bookingDepartureTime),new Timestamp(bookingArrivalTime), "", "Ride", new Timestamp(bookingEndTimeMillis), 0, false);
		Route route2 = routeDao.addRoute(test2.getUserID(), 1000, "", "There", new Timestamp(bookingDepartureTime),new Timestamp(bookingArrivalTime), "", "Ride", new Timestamp(bookingEndTimeMillis), 0, false);
